...
builder.Services.AddControllers(
    opt =>
    {
        ...
        opt.CacheProfiles.Add(Constants.ResponseCacheLongTermProfile, new CacheProfile { Duration = (int)TimeSpan.FromDays(1).TotalSeconds, Location = ResponseCacheLocation.Any });
    }
);
